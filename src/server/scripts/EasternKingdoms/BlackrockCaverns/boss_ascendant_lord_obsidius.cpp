...
enum Spells
{
    SPELL_THUNDERCLAP = 76186, SPELL_TWILIGHT_CORRUPTION = 93613, SPELL_STONE_BLOW = 76185,
};

enum Events
{
    EVENT_THUNDERCLAP = 1, EVENT_TWILIGHT_CORRUPTION = 2, EVENT_STONE_BLOW = 3,
};
...
{
public:
    boss_ascendant_lord_obsidius () :
            CreatureScript("boss_ascendant_lord_obsidius")
    {
    }
    ...
    {
        boss_ascendant_lord_obsidiusAI (Creature* creature) :
                ScriptedAI(creature)
        {
