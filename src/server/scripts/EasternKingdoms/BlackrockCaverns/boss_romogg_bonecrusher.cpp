...
{
public:
    boss_romogg_bonecrusher () :
            CreatureScript("boss_romogg_bonecrusher")
    {
    }
    ...
    {
        boss_romogg_bonecrusherAI (Creature* creature) :
                ScriptedAI(creature), castSkullCracker(false), chainsOfWoe(NULL)
        {
